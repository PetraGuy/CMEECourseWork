...
This analysis will take the vegetation data and compute species richness by nest and by plot. These values will be saved to CSV files which can be added to the Nest and Plot level data sets
